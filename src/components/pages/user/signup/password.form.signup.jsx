...
import { validPassword, validText } from "../../../../ultis/validator"
    ...
    return (
        <div className=" flex flex-col gap-6">
           <div>
            ...
            <div>
                <TextBox options={{sameValue: signupData['password']}} validator={validText} action={action} heading={'Xác nhận mật khẩu:'} placeHolder={'Xác nhận mật khẩu trùng khớp với mật khẩu đã tạo'} data={signupData['confirmPassword']} fieldName={'confirmPassword'} ></TextBox>
            </div>
        </div>
    )
}